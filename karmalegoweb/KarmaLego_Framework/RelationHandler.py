class AllenSevenRelationEngine(object):
    ...
    def __init__(self):
        ...
        for column in range(
            AllenSevenRelationEngine.OVERLAP, AllenSevenRelationEngine.FINISHBY + 1
        ):
            self._transitivity_table[row][column].append(AllenSevenRelationEngine.BEFORE)
            self._transitivity_table[row][column].append(AllenSevenRelationEngine.MEET)
            self._transitivity_table[row][column].append(AllenSevenRelationEngine.OVERLAP)
        for relation in range(
            AllenSevenRelationEngine.BEFORE, AllenSevenRelationEngine.CONTAIN + 1
        ):
        ...
        self._transitivity_table[row][AllenSevenRelationEngine.STARTS].append(
            AllenSevenRelationEngine.OVERLAP
        )
        self._transitivity_table[row][AllenSevenRelationEngine.EQUAL].append(
        ...
        for relation in range(
            AllenSevenRelationEngine.OVERLAP, AllenSevenRelationEngine.CONTAIN + 1
        ):
        ...
        self._transitivity_table[row][AllenSevenRelationEngine.FINISHBY].append(
            AllenSevenRelationEngine.CONTAIN
        )
        self._transitivity_table[row][AllenSevenRelationEngine.CONTAIN].append(
            AllenSevenRelationEngine.CONTAIN
        )
        self._transitivity_table[row][AllenSevenRelationEngine.EQUAL].append(
            AllenSevenRelationEngine.CONTAIN
    ...
    def print_transitivity_table(self):
        for i in range(AllenSevenRelationEngine.BEFORE, AllenSevenRelationEngine.EQUAL + 1):
            ...
            for j in range(AllenSevenRelationEngine.BEFORE, AllenSevenRelationEngine.EQUAL + 1):
                st += (
                    str([self.get_short_description(rel) for rel in self._transitivity_table[i][j]])
                    + "  "
                )
...
class KLRelationEngine(object):
    ...
    def __init__(self):
        self._relation_map_kl = {
            "NOT_DEFINED": KLRelationEngine.NOT_DEFINED,
            "BEFORE": 0,
            "OVERLAP": 1,
            "CONTAIN": 2,
        }
        ...
        self._transitivity_table[relation] = {}
        self._transitivity_table[relation][KLRelationEngine.BEFORE] = [KLRelationEngine.BEFORE]
        self._transitivity_table[relation][KLRelationEngine.OVERLAP] = [
            KLRelationEngine.BEFORE,
            KLRelationEngine.OVERLAP,
        ]
        self._transitivity_table[relation][KLRelationEngine.CONTAIN] = [
            KLRelationEngine.BEFORE,
            KLRelationEngine.OVERLAP,
        ...
        self._transitivity_table[relation] = {}
        self._transitivity_table[relation][KLRelationEngine.BEFORE] = [
            KLRelationEngine.BEFORE,
            KLRelationEngine.OVERLAP,
            KLRelationEngine.CONTAIN,
        ]
...
class EqualRelationEngine(object):
    ...
    def __init__(self):
        self._relation_map_kl = {
            "NOT_DEFINED": EqualRelationEngine.NOT_DEFINED,
        ...
        self._transitivity_table[EqualRelationEngine.EQUAL][EqualRelationEngine.EQUAL] = [
            EqualRelationEngine.EQUAL
        ]
        self._transitivity_table[EqualRelationEngine.EQUAL][EqualRelationEngine.BEFORE] = [
            EqualRelationEngine.BEFORE
        ]
        self._transitivity_table[EqualRelationEngine.BEFORE][EqualRelationEngine.EQUAL] = [
            EqualRelationEngine.BEFORE
        ]
        self._transitivity_table[EqualRelationEngine.BEFORE][EqualRelationEngine.BEFORE] = [
            EqualRelationEngine.BEFORE
        ]
...
class BeforeRelationEngine(object):
    ...
    def __init__(self):
        self._relation_map_kl = {"NOT_DEFINED": BeforeRelationEngine.NOT_DEFINED, "BEFORE": 0}
