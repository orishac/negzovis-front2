...
class OutliersRemover(Transformation):
    """
        ...
        From version 1.3 and onwards, outliers removal won't run by default.
        To use outliers removal, insert a value >= 0.
    """
    def __init__(self, std_coefficient=-1):
