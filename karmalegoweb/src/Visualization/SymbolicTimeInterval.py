class SymbolicTimeInterval(object):
    ...
    def __init__(
        self, start_time=None, end_time=None, symbol=None, var_id=None
    ):  # , duration=None, offset_from_start=None, offset_from_end=None):
    ...
    def __eq__(self, other):
        return (
            ...
            and self._var_id == other._var_id
        )
    ...
    def to_string(self):
        return (
            "SymbolicTimeInterval: { Symbol.py: "
            + str(self._symbol)
            + ", startTime: "
