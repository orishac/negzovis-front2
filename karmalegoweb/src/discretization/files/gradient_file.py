...
class gradient_file:
    def __init__(self, gradient_file_raw, dir_path) -> None:
        gradient_file_raw.filename = secure_filename("states_kb_gradient.csv")
        self.path = os.path.join(dir_path, gradient_file_raw.filename)
        gradient_file_raw.save(self.path)
    ...
    #             path_to_compare
    #         ):  # if the current disc is not a gradient/kb disc, then skip it
    #             continue
